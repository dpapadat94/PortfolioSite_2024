      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <div className="flex justify-start gap-5 ">
          <Link
            ...
            duration={500}
          >
            <button className=" text-white border-2 rounded-full px-8 py-3 my-2 flex items-center hover:bg-[#4CB9E7] ">
              See my Work
          ...
          <a className="" href="/">
            <button className="max-sm:text-sm  text-white rounded-full  border-2 px-8 py-3 my-2 sm:flex items-center   hover:bg-[#4CB9E7]">
              My Resume
